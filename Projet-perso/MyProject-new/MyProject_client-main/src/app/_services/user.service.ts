...
export class UserService {
  ...
  updateUser(formData: FormData, idUser: string): Observable<User> {
    return this.http.put<User>(USER_API + "update/" + idUser, formData);
  }

  deleteUser(id: string): Observable<any>{
    return this.http.delete<Object>(USER_API + "delete/" + id, httpOptions)
  }
}
